...
export function FixHydrationClient() {
  useEffect(() => {
    ...
    if (body.hasAttribute("saccades-color")) body.removeAttribute("saccades-color");
    if (body.hasAttribute("fixation-strength")) body.removeAttribute("fixation-strength");
    if (body.hasAttribute("saccades-interval")) body.removeAttribute("saccades-interval");
